...
namespace TrackingFolder.API.Migrations
{
    ...
    [Migration("20250819080001_Addd DbSet GExMeasureResults")]
    partial class AdddDbSetGExMeasureResults
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackingFolder.API.Models.GoldExpertMachine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("326dda81-124e-4cdc-9be9-2c9bc4edc3ae"),
                            FolderPath = "/path/to/machine1",
                            IsDeleted = false,
                            Model = "ModelX",
                            ModifiedBy = "system",
                            ModifiedOn = 1755590401L,
                        ...
                        new
                        {
                            Id = new Guid("aca252c7-ae91-40d1-af36-3fe3fbaf4a99"),
